...
function products_Details(productDaTa) {

var productcard = document.createElement("div");


//ASSIGNING A CLASS NAME COMPLETE card
...
productName.className = "product-nAame";
...
details.appendChild(productBrand);


var productPrice = document.createElement("h5");
productPrice.className = "product-price";
productPrice.innerText = "Rs " + productDaTa.price;
...
products_Details(productList[i]);
}